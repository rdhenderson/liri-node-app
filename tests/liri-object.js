...
function Liri () {
	...
	this.questions =  questions.cmd;

	// create object listing liri commands/actions
	var that = this; //Put Liri context into 'that' to access in command object

	this.command = {
		'my-tweets': this.listTweets,
		'spotify-this-song': this.listSpotify,
		'movie-this': this.listMovie,
		'do-what-it-says': this.listFile,
...
Liri.prototype.init = function () {
	console.log(hr + "Welcome! LIRI the BENEVOLENT hears you. LIRI will help." + hr);
	//this.cmdLineInterface = true;
};

Liri.prototype.listen = function () {
...
Liri.prototype.listFile = function (args) {
...
Liri.prototype.listMovie = function (args) {
...
Liri.prototype.listSpotify = function (args) {
...
Liri.prototype.listTweets = function (args) {
