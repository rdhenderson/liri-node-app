...
function Liri () {
	...
	that = this; //Put Liri context into 'that' to access in command object
	...
	this.listen = function () {
		inquirer.prompt(this.questions).then(function(response){
			...
			that.parse(args.trim().split(' '));
		});
	};

	this.listFile = function (args) {
	...
	this.listSpotify = function (args) {
